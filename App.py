...
# 3. EXTRAÇÃO DIRETA COM O CLIENTE OFICIAL DO BIGQUERY (Sem dependência de browser)
...
def carregar_dados_reais_bigquery():
    ...
    # Cliente oficial do BigQuery que se conecta via Conta de Serviço sem exigir browser
...
# 6. RENDERIZAÇÃO DO MAPA COM MARKER CLUSTER
